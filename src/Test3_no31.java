class Test3_no31 {
    class Car {
        ...
        Car(String name, String number, int width, int height, int length,
            ...
            this.name = name; this.number = number; this.width = width; this.height = height; this.length = length;
            this.tankage = tankage; this.fuel = (fuel <= tankage) ? fuel : tankage;
    ...
    public static void main(String[] args) {
        Test3_no31 t = new Test3_no31();
        Car k3 = t.new Car("k3","서울999-99",1660,1500,3640,40.0,35.0,12.0);
        Car k5 = t.new Car("k5","서울999-98",1660,1525,3695,41.0,35.0,12.0);
